...
public interface EidopRepository extends JpaRepository<Dual, Long> {
        ...
        @Query(nativeQuery = true,
               value =
                       ...
                       "         rtr_nea - rtr_prohg                                                    as katkyb,                                                      \n" +
                       "         rtr_xre_kyb                                                            as xrekyb,                                                      \n" +
                       "         rtr_tot_poso                                                           as rtrtotposo,                                                  \n" +
                       ...
                       "            and (trim(to_char(ydr_ftran_h.rtr_etos,'0000'))||trim(to_char(ydr_ftran_h.rtr_trim,'00')) <= :fromdate ) )  as previousperiods,    \n" +
                       "         case rma_status                                                                                                                         \n" +
                       "              when 1 then 'ΕΝΕΡΓΟΣ'                                                                                                              \n" +
                       "              when 5 then 'ΔΙΑΚΟΠΗ'                                                                                                              \n" +
                       "              when 9 then 'ΕΞΑΓΩΓΗ'                                                                                                              \n" +
                       "         end                                                                     as status,                                                      \n" +
                       "         trim(to_char(nvl('202003','000000'),'000000'))                          as periodfrom,                                                  \n" +
                       "         trim(to_char(nvl('202003','999999'),'000000'))                          as periodto ,                                                   \n" +
                       ...
                       "         rtr_nea                                                                 as nea,                                                         \n" +
                       "         rtr_prohg                                                               as prohg,                                                       \n" +
                       "         rtr_date_orist                                                          as dateorist,                                                   \n" +
                       "         rtr_date_lhxh                                                           as datelhxh,                                                    \n" +
